...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM44_NPM1c_191_citrate/NPM1c_191/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(y.coord < 10340, x.coord <11800, x.coord > 3622, y.coord > 2600)
...
codex_AML1 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM44_AML1_191_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_AML1, "/mnt/isilon/tan_lab_imaging/Analysis/bandyopads/NBM_CODEX_Atlas/Combined_Analysis/Seurat/ReferenceMap_AML_Step6/objects/codex_AML1_191_SeuratObj.RDS")
