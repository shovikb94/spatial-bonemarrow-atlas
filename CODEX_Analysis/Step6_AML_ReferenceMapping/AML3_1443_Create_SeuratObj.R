...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM54_NPM1C_1443_CITRATE/NBM54_1443/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(y.coord >3500, y.coord <13000, x.coord > 3000, x.coord < 6250)
...
codex_AML3_1443 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM54_AML3_1443_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_AML3_1443 , "/mnt/isilon/tan_lab_imaging/Analysis/bandyopads/NBM_CODEX_Atlas/Combined_Analysis/Seurat/ReferenceMap_AML_Step6/objects/codex_AML3_1443_SeuratObj.RDS")
