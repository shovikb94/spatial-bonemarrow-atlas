...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM51_NPM1C_183_REIMAGE_CITRATE/NPM1C_183/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(y.coord < 7684, x.coord <4686, x.coord > 1552, y.coord > 3400)
...
codex_AML1 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM51_AML2_183_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_AML1, "/mnt/isilon/tan_lab_imaging/Analysis/bandyopads/NBM_CODEX_Atlas/Combined_Analysis/Seurat/ReferenceMap_AML_Step6/objects/codex_AML2_183_SeuratObj.RDS")
