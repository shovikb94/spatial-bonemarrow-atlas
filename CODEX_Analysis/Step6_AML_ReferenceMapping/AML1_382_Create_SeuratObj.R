...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM46_NPM1c_382_citrate/NPM1c_382/Scan2/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(y.coord < 16828)
...
codex_AML1 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM46_AML1_382_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_AML1, "/mnt/isilon/tan_lab_imaging/Analysis/bandyopads/NBM_CODEX_Atlas/Combined_Analysis/Seurat/ReferenceMap_AML_Step6/objects/codex_AML1_382_SeuratObj.RDS")
