### NBM39_H41 Seurat Object Generation Script
### This script takes as input a channel_names text file and the cell X protein output of our Mesmer pipeline and outputs a Seurat Object for NBM39
...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM39_H41_citrate/H41/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(x.coord < 14880, y.coord >5680, x.coord > 7050, y.coord < 13400)
...
codex_H41 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM39_H41_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H41, "codex_H41_SeuratObj.RDS")
