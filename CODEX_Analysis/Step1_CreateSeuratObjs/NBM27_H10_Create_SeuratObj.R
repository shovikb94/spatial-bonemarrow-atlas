...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM27_H10_CITRATE_REIMAGE/H10/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(y.coord < 16000)
...
codex_H10 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM27_H10_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H10, "codex_H10_SeuratObj.RDS")
