### NBM28_H14 Seurat Object Generation Script
### This script takes as input a channel_names text file and the cell X protein output of our Mesmer pipeline and outputs a Seurat Object for NBM28
...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM28_H14_citrate/H14/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(y.coord < 12500)
...
codex_H14 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM28_H14_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H14, "codex_H14_SeuratObj.RDS")
