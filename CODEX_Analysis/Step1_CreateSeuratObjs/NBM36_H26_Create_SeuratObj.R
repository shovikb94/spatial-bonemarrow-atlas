### NBM36_H26 Seurat Object Generation Script
### This script takes as input a channel_names text file and the cell X protein output of our Mesmer pipeline and outputs a Seurat Object for NBM36
...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM36_H26_citrate_reimage/H26/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(x.coord < 17500, y.coord >4000, x.coord > 8676, y.coord < 15000)
cells_to_remove <- subset(gc_csd_raw, subset = x.coord < 10968 & y.coord > 6000 & x.coord > 10286 & y.coord < 6908) # Use this line to further crop out piece which had artifact
...
codex_H26 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM36_H26_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H26, "codex_H26_SeuratObj.RDS")
