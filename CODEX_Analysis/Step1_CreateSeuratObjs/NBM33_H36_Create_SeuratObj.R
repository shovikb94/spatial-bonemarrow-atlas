### NBM33_H36 Seurat Object Generation Script
### This script takes as input a channel_names text file and the cell X protein output of our Mesmer pipeline and outputs a Seurat Object for NBM33
...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM33_H36_citrate/H36/Scan1/mesmercombined_markers.csv'
...
codex_H36 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM33_H36_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H36, "codex_H36_SeuratObj.RDS")