### NBM41_H27 Seurat Object Generation Script
### This script takes as input a channel_names text file and the cell X protein output of our Mesmer pipeline and outputs a Seurat Object for NBM41
...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM41_H27_citrate/H27/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(x.coord < 13000, y.coord >3500, x.coord > 2500, y.coord < 14000)
...
codex_H27 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM41_H27_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H27, "codex_H27_SeuratObj.RDS")
