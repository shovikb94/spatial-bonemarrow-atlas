### NBM40_H39 Seurat Object Generation Script
### This script takes as input a channel_names text file and the cell X protein output of our Mesmer pipeline and outputs a Seurat Object for NBM40
...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM40_H39_citrate/H39/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(x.coord < 14000, y.coord >3500, x.coord > 3000, y.coord < 14000)
...
codex_H39 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM40_H39_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H39, "codex_H39_SeuratObj.RDS")
