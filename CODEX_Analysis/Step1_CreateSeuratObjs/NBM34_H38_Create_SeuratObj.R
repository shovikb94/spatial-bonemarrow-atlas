### NBM34_H38 Seurat Object Generation Script
### This script takes as input a channel_names text file and the cell X protein output of our Mesmer pipeline and outputs a Seurat Object for NBM34
...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM34_H38_citrate/H38/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(x.coord < 15000, y.coord >4800, x.coord > 3000, y.coord < 14000)
cells_to_remove <- subset(gc_csd_raw, subset = x.coord < 11126 & y.coord > 9408 & x.coord > 10486 & y.coord < 10618) # Use this line to further crop out piece which had artifact
...
codex_H38 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM34_H38_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H38, "codex_H38_SeuratObj.RDS")
