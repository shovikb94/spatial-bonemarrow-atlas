### NBM31_H32 Seurat Object Generation Script
### This script takes as input a channel_names text file and the cell X protein output of our Mesmer pipeline and outputs a Seurat Object for NBM31
...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM31_H32_citrate_reimage/H32/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(x.coord < 13000, x.coord > 5000, y.coord > 4900, y.coord < 12500)
...
codex_H32 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM31_H32_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H32, "codex_H32_SeuratObj.RDS")
