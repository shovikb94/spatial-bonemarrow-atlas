### NBM32_H37 Seurat Object Generation Script
### This script takes as input a channel_names text file and the cell X protein output of our Mesmer pipeline and outputs a Seurat Object for NBM32
...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM32_H37_citrate//H37/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(x.coord < 17000, y.coord >3500, x.coord > 5200, y.coord < 15000)
cells_to_remove <- subset(gc_csd_raw, subset = x.coord >12953 & y.coord < 8480) # Use this line to further crop out piece which had artifact
...
codex_H37 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM32_H37_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H37, "codex_H37_SeuratObj.RDS")
