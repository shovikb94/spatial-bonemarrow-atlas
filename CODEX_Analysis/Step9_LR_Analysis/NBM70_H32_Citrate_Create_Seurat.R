...
channel_names <- read_csv(file = "/mnt/isilon/tan_lab/sussmanj/CODEX/NBM_Receptor_Ligand/NBM70/MarkerList.txt", col_names = FALSE)

#Specify the directory of your data
file_path = '/mnt/isilon/tan_lab/sussmanj/CODEX/NBM_Receptor_Ligand/NBM70/mesmer/combined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(y.coord < 62000, x.coord < 17500, x.coord > 6500, y.coord > 49000)
...
codex_assay <- CreateAssayObject(counts = t_gc_csd, project = "NBM70_H32_Citrate_CODEX", assay="CODEX", meta.data = gc_csd_raw)
codex_seurat <- CreateSeuratObject(t_gc_csd, project = "NBM70_H32_Citrate_CODEX", assay="CODEX", meta.data = gc_csd_raw)
codex_seurat[["CODEX"]] = codex_assay
saveRDS(codex_seurat, "/mnt/isilon/tan_lab/sussmanj/CODEX/NBM_Receptor_Ligand/Seurat_Objects/NBM70_H32_Citrate_CODEX_SeuratObj.RDS")
