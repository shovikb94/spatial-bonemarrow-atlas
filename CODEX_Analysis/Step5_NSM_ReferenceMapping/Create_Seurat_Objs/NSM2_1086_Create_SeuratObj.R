...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM49_Negative_1086_citrate/Negative_1086/Scan1/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(x.coord > 19692) # significant crop to remove regions of clot not represented in reference map
...
codex_H10 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM49_NSM2_1086_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H10, "/mnt/isilon/tan_lab_imaging/Analysis/bandyopads/NBM_CODEX_Atlas/Combined_Analysis/Seurat/ReferenceMap_NSM_Step5/NSM_seurat_objs/codex_NSM2_1086_SeuratObj.RDS")
