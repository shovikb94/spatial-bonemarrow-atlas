...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM48_Negative_1720_citrate/Negative_1720/Scan2/mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(y.coord < 30442, x.coord <8500, x.coord > 3000, y.coord > 4000)
...
codex_H10 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM48_NSM1_1720_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H10, "/mnt/isilon/tan_lab_imaging/Analysis/bandyopads/NBM_CODEX_Atlas/Combined_Analysis/Seurat/ReferenceMap_NSM_Step5/NSM_seurat_objs/codex_NSM1_1720_SeuratObj.RDS")
