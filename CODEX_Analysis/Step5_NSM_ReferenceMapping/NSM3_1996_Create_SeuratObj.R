### NBM27_H10 Seurat Object Generation Script
...
file_path = '/mnt/isilon/tan_lab_imaging/FUSION/NBM47_Negative_1996_citrate/NegativeStaging_1996/Scan1//mesmercombined_markers.csv'
...
gc_csd_raw <- gc_csd_raw %>% dplyr::filter(x.coord > 12425, y.coord < 15200, y.coord > 4000, x.coord < 19000 ) # significant crop to remove regions of clot not represented in reference map
...
codex_H10 <- CreateSeuratObject(t_gc_csd, project = "SB67_NBM47_NSM3_1996_CODEX_Mesmer", assay="CODEX", meta.data = gc_csd_raw)
saveRDS(codex_H10, "/mnt/isilon/tan_lab_imaging/Analysis/bandyopads/NBM_CODEX_Atlas/Combined_Analysis/Seurat/ReferenceMap_NSM_Step5/NSM_seurat_objs/codex_NSM3_1996_SeuratObj.RDS")
